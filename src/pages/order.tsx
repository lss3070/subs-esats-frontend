...
import { ORDERS_FRAGMENT, FULL_ORDER_FRAGMENT } from '../fragments';
...
export const Order =()=>{
    ...
    const {data:subscriptData}= useSubscription<orderUpdates,orderUpdatesVariables>
    (ORDER_SUBSCRIPTION,{
        variables:{
            input:{
                id: +params.id,
                ...
                <div className="p-5 text-xl grid gap-6">
                    ...
                    )}
                    {
                       ...
                       {userData?.me.role===UserRole.Delivery && (
                        ...
                        {data?.getOrder.order?.status===OrderStatus.PickedUp && (
                            <button onClick={()=>onButtonClick(OrderStatus.Deliverd)} 
                            className="btn">
                    ...
                    )}
                    {
                        data?.getOrder.order?.status===OrderStatus.Deliverd
                         &&(
                            <span className="text-center mt-5 mb-3 text-2xl text-lime-600">
                                Thank you for your using Sub's Eats
                            </span>
                        )
                    }
                </div>
